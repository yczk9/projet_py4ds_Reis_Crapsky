...
# ============================================================================
# IMPORT DES DONNÉES POUR L'ACP
# ============================================================================

from import_fao import get_datas_fao, format_annees
...
df= get_datas_fao(liste_pays, liste_indicateurs, liste_années)
...
# Extraction des données pour l'ACP (suppression des valeurs manquantes) Il n'y en a pas normalement
